...
namespace SheepFit6.Controllers
{
    public class AnimalsController : Controller
    {
        private readonly SheepContext _context;

        public AnimalsController(SheepContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,sheepID,DOB,Gender")] Animal animal)
        {
            if (id != animal.ID)
            {
                return NotFound();
